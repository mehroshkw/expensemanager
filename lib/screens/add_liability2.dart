...
import 'package:expensemanager/screens/edit_liability.dart';
import 'package:expensemanager/widegts/reusablebutton.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';

class AddLiability2Screen extends StatelessWidget {
  const AddLiability2Screen({Key? key}) : super(key: key);
                        ...
                        children: [
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                    color: !toTake ? Colors.red : const Color(0xffd4f8de),
                                    borderRadius: const BorderRadius.only(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          height: 50.0,
                          child: ReusablePrimaryButton(buttonText: 'Continue', onTap: () { Get.to(EditLiability());  },)
                      ),
                    ],
                  ),
                ),
